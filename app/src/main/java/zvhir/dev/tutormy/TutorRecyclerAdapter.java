...
public class TutorRecyclerAdapter extends RecyclerView.Adapter<zvhir.dev.tutormy.TutorRecyclerAdapter.ImageViewHolder> {
    private Context mContext;
    private List<Upload> mUploads;
    private OnItemClickListener mListener;

    public TutorRecyclerAdapter(Context context, List<Upload> uploads) {
        mContext = context;
        mUploads = uploads;
    }
    ...
    public ImageViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(mContext).inflate(R.layout.tutor_recycler_adapter, parent, false);
    ...
    public void onBindViewHolder(ImageViewHolder holder, int positionAdmin) {
        ...
        holder.mAdminDelete.setTag(positionAdmin); // set and store unique position of button
    ...
    public class ImageViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public Button mAdminDelete;
        public ImageViewHolder(View itemView) {
            super(itemView);

            mAdminDelete = itemView.findViewById(R.id.adminDeleteButton);
